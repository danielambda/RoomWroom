...
public sealed class Room : AggregateRoot<RoomId>
{
    ...
    private Room(RoomId id, string name, Money budget, decimal budgetLowerBound,
    ...
    public static Room Create(
        RoomId id, string name, Money budget, decimal budgetLowerBound,
        IEnumerable<UserId> userIds, IEnumerable<OwnedShopItem> ownedShopItems)
        => new(id, name, budget, budgetLowerBound, userIds, ownedShopItems);

    public static Room CreateNew(
        string name, Money budget, decimal budgetLoverBound,
        IEnumerable<UserId> userIds, IEnumerable<OwnedShopItem> ownedShopItems) =>
